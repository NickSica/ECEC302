...
HD_PWD='C:/Users/njs82/Documents/xilinx_projects/ck_div/ck_div.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ck_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ck_div.tcl
