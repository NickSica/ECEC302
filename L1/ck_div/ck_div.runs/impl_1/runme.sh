...
HD_PWD='C:/Users/njs82/Documents/xilinx_projects/ck_div/ck_div.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ck_div.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ck_div.tcl -notrace
