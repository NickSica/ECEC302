...
HD_PWD='C:/Users/njs82.DREXEL/synch_ckt/synch_ckt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synch_ckt_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synch_ckt_test.tcl
