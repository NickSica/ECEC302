...
HD_PWD='C:/Users/njs82.DREXEL/synch_ckt/synch_ckt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log synch_ckt_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source synch_ckt_test.tcl -notrace
