...
HD_PWD='C:/Users/njs82.DREXEL/router/router.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log router_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source router_tb.tcl
