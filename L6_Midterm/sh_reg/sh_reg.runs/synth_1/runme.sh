...
HD_PWD='C:/Users/njs82.DREXEL/sh_reg/sh_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sh_reg_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sh_reg_test.tcl
