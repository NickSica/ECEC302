...
HD_PWD='C:/Users/njs82.DREXEL/sh_reg/sh_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sh_reg_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sh_reg_test.tcl -notrace
