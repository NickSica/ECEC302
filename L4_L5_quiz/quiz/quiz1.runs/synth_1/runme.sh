...
HD_PWD='C:/Users/njs82/Documents/quiz1/quiz1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stack_reg_5_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stack_reg_5_tb.tcl
