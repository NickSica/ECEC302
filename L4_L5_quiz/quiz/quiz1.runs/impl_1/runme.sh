...
HD_PWD='C:/Users/njs82/Documents/quiz1/quiz1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stack_reg_5_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stack_reg_5_tb.tcl -notrace
