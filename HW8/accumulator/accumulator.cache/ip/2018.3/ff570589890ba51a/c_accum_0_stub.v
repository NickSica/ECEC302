...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(B, CLK, ADD, CE, BYPASS, SCLR, Q)
/* synthesis syn_black_box black_box_pad_pin="B[3:0],CLK,ADD,CE,BYPASS,SCLR,Q[7:0]" */;
  input [3:0]B;
  input CLK;
  input ADD;
  input CE;
