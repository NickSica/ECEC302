...
HD_PWD='C:/Users/xoepe/Documents/ECEC302/L10/handshake/handshake.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handshakes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handshakes.tcl
