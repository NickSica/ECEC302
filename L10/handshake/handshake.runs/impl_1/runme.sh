...
HD_PWD='C:/Users/xoepe/Documents/ECEC302/L10/handshake/handshake.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log handshakes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source handshakes.tcl -notrace
