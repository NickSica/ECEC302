...
set_property PACKAGE_PIN W18 [get_ports {d_out2[0]}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {d_out2[0]}]
set_property PACKAGE_PIN U15 [get_ports {d_out2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d_out2[1]}]
set_property PACKAGE_PIN U14 [get_ports {d_out2[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d_out2[2]}]
set_property PACKAGE_PIN V14 [get_ports {d_out2[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {d_out2[3]}]
